import{E as h,o as _}from"./VertexArrayObject-Cyp5IHr1.js";import{x as y,s as j}from"./FramebufferObject-B0AiVv3c.js";import{r as c}from"./ProgramTemplate-BQ_ghDjY.js";import{e as v,a as O}from"./ProgramTemplate-BQ_ghDjY.js";import{gl as w}from"./index-DShDdPBX.js";import{t as l}from"./NestedMap-GuqgquCN.js";class ${constructor(e){this._rctx=e,this._store=new l}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function p(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function d(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
