import{lg as Q,dM as ta,lf as $e,j5 as Ee,iE as _e,lo as oa,iQ as je,iF as Pa,dF as U,av as $,op as Ra,Ai as q,a0 as me,ko as ra,lO as ne,aF as s,aG as be,aH as Fa,fq as oe,gg as Da,gk as Ve,gn as ja,gl as Va,c$ as Ba,jX as Ha,my as Wa,mM as Ua,bO as qa,q9 as E,bI as Ya,n1 as Za,sU as ka,mV as Be,lt as He,aZ as Xa,ax as Ja,b7 as Ka,cG as Te,dv as Qa,dB as We,du as et,iC as at}from"./index-DShDdPBX.js";import{H as tt}from"./InterleavedLayout-CDpjlbo1.js";import{n as g,u as ee,t as Ue,o as Me,r as ot}from"./ShaderOutput-DnYY5J1_.js";import{n as z,a as T,t as he}from"./NormalAttribute.glsl-B35kzUQK.js";import{aO as ze,aZ as h,z as ia,a_ as rt,a$ as it,b0 as G,b1 as nt,b2 as st,b3 as lt,D as se,p as ct,K as dt,q as ut,h as I,an as R,c as j,a2 as V,b4 as B,a4 as K,G as N,a6 as H,au as mt,a5 as ht,b5 as ft,ak as F,b6 as pt,J as na,as as sa,F as la,aX as ca,S as vt,P as Ae,Q as fe,I as da,b7 as gt,i as le,aP as xt,T as bt,U as we,R as re,m as ua,o as O,B as Oe,C as ce,l as Tt,b8 as Mt,b9 as wt,L as St,aa as yt,ba as ma,bb as ha,g as de,bc as fa,a3 as pa,a9 as va,a8 as ga,a7 as xa,H as ue,bd as ba,W as Ct,V as qe,af as Nt,ag as Ot,ah as $t,ai as Et,ab as _t,ac as zt,ad as At,ae as It,aj as Gt,al as P,$ as d,v as Lt,A as Se,am as Pt,az as Rt,x as Ft,d as Dt,ao as jt,y as Vt,aJ as Bt}from"./VerticalOffset.glsl-CeVo2w28.js";import{i as A,a as Ye,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{B as Ie,g as Ge,f as Ht}from"./renderState-CYAXYtvr.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{a as Le}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-algzA847.js";import"./boundedPlane-CkDcseh7.js";import{o as Wt,r as Ut}from"./doublePrecisionUtils-B0owpBza.js";function qt(a){a.vertex.code.add(r`
  ...
  `)}function Xo({normalTexture:a,metallicRoughnessTexture:e,metallicFactor:t,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return a==null&&e==null&&i==null&&(n==null||ta(n,$e))&&c==null&&(o==null||o===1)&&(t==null||t===1)}const Yt=Q(1,1,.5),Jo=Q(0,.6,.2),Ko=Q(0,1,.2);function Zt(a){const e=a.fragment.code;e.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
return outColor;
}`))}function Qo(a,e){const t=a.fragment.code;a.include(ze),t.add(r`
...
}`)}let Xt=class extends ia{constructor(e,t,o){super(e,"mat4",Le.Pass,(i,n,c)=>i.setUniformMatrix4fv(e,t(n,c)),o)}};function Jt(a,e){const t=a.fragment;switch(t.code.add(r`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
}`);break;case T.ScreenDerivative:a.vertex.code.add(r`void forwardNormal() {}`);break;default:Ee(e.normalType);case T.COUNT:}}let Kt=class extends rt{constructor(){super(...arguments),this.transformNormalViewFromGlobal=_e()}},Qt=class extends nt{constructor(){super(...arguments),this.transformNormalGlobalFromModel=_e(),this.toMapSpace=oa()}};function wa(a){a.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return posClip;
}`)}const ke=_e();function Sa(a,e){const t=e.hasModelTransformation,o=e.instancedDoublePrecision;t&&(a.vertex.uniforms.add(new st("model",n=>n.modelTransformation??je)),a.vertex.uniforms.add(new G("normalLocalOriginFromModel",n=>(Pa(ke,n.modelTransformation??je),ke)))),e.instanced&&o&&(a.attributes.add(b.INSTANCEMODELORIGINHI,"vec3"),a.attributes.add(b.INSTANCEMODELORIGINLO,"vec3"),a.attributes.add(b.INSTANCEMODEL,"mat3"),a.attributes.add(b.INSTANCEMODELNORMAL,"mat3"));const i=a.vertex;o&&(i.include(lt,e),i.uniforms.add(new se("viewOriginHi",n=>Wt(U(ie,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),ie)),new se("viewOriginLo",n=>Ut(U(ie,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),ie)))),i.code.add(r`
...
return fallOffFunction(vv, vn, 0.1);
      ...
      fragOcclusion = A;`),a}function ge(a){return Math.max(10,20*a.computeScreenPixelSizeAtDist(Math.abs(4*a.relativeElevation)))}const Ke=ra(),co=Object.freeze(Object.defineProperty({__proto__:null,build:Oa,getRadius:ge},Symbol.toStringTag,{value:"Module"}));let Qe=class extends Ae{constructor(e,t){super(e,t,new fe(co,()=>me(()=>Promise.resolve().then(()=>Go),void 0)))}initializePipeline(){return Ie({colorWrite:Ge})}};const J=2;let X=class extends bt{constructor(a){super(a),this.consumes={required:["normals"]},this.produces=we.SSAO,this.isEnabled=()=>!1,this._enableTime=oe(0),this._passParameters=new no,this._drawParameters=new lo}initialize(){const a=Uint8Array.from(atob(ro),t=>t.charCodeAt(0)),e=new Da;e.wrapMode=Ve.CLAMP_TO_EDGE,e.pixelFormat=ja.RGB,e.wrapMode=Ve.REPEAT,e.hasMipmap=!0,e.width=32,e.height=32,this._passParameters.noiseTexture=new Va(this.renderingContext,e,a),this.techniques.precompile(Qe),this.techniques.precompile(Xe),this.addHandles(Ba(()=>this.isEnabled(),()=>this._enableTime=oe(0)))}destroy(){this._passParameters.noiseTexture=Ha(this._passParameters.noiseTexture)}render(a){const e=this.bindParameters,t=a.find(({name:y})=>y==="normals"),o=t==null?void 0:t.getTexture(),i=t==null?void 0:t.getTexture(Wa),n=this.fboCache,c=e.camera,m=c.fullViewport[2],u=c.fullViewport[3],p=Math.round(m/J),x=Math.round(u/J),M=this.techniques.get(Qe),w=this.techniques.get(Xe);if(!M.compiled||!w.compiled)return this._enableTime=oe(performance.now()),this.requestRender(Ye.UPDATE),n.acquire(p,x,we.SSAO,re.RED);this._enableTime===0&&(this._enableTime=oe(performance.now()));const f=this.renderingContext,L=this.view.qualitySettings.fadeDuration,S=c.relativeElevation,te=qa((Ze-S)/(Ze-kt),0,1),Y=L>0?Math.min(L,performance.now()-this._enableTime)/L:1,xe=Y*te;this._passParameters.normalTexture=o,this._passParameters.depthTexture=i,this._passParameters.projScale=1/c.computeScreenPixelSizeAtDist(1),this._passParameters.intensity=4*uo/ge(c)**6*xe;const Z=n.acquire(m,u,"ssao input",re.RG);f.bindFramebuffer(Z.fbo),f.setViewport(0,0,m,u),f.bindTechnique(M,e,this._passParameters,this._drawParameters),f.screen.draw();const k=n.acquire(p,x,"ssao blur",re.RED);f.bindFramebuffer(k.fbo),this._drawParameters.colorTexture=Z.getTexture(),ne(this._drawParameters.blurSize,0,J/u),f.bindTechnique(w,e,this._passParameters,this._drawParameters),f.setViewport(0,0,p,x),f.screen.draw(),Z.release();const D=n.acquire(p,x,we.SSAO,re.RED);return f.bindFramebuffer(D.fbo),f.setViewport(0,0,m,u),f.setClearColor(1,1,1,0),f.clear(Ua.COLOR),this._drawParameters.colorTexture=k.getTexture(),ne(this._drawParameters.blurSize,J/m,0),f.bindTechnique(w,e,this._passParameters,this._drawParameters),f.setViewport(0,0,p,x),f.screen.draw(),f.setViewport4fv(c.fullViewport),k.release(),Y<1&&this.requestRender(Ye.UPDATE),D}};s([be()],X.prototype,"consumes",void 0),s([be()],X.prototype,"produces",void 0),s([be({constructOnly:!0})],X.prototype,"isEnabled",void 0),X=s([Fa("esri.views.3d.webgl-engine.effects.ssao.SSAO")],X);const uo=.5;function Re(a,e){const t=a.fragment;e.receiveAmbientOcclusion?(t.uniforms.add(new ua("ssaoTex",o=>{var i;return(i=o.ssao)==null?void 0:i.getTexture()})),t.constants.add("blurSizePixelsInverse","float",1/J),t.code.add(r`float evaluateAmbientOcclusionInverse() {
...
}`))}const ea=$(),_=oa();function Fe(a){a.constants.add("ambientBoostFactor","float",wt)}function De(a){a.uniforms.add(new le("lightingGlobalFactor",e=>e.lighting.globalFactor))}function $a(a,e){const t=a.fragment;switch(a.include(Re,e),e.pbrMode!==h.Disabled&&a.include(Pe,e),a.include(mo,e),a.include(ze),t.code.add(r`
