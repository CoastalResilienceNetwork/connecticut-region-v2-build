import{E as h,o as _}from"./VertexArrayObject-0WsJc1M3.js";import{x as y,s as j}from"./FramebufferObject-DHtuBX81.js";import{r as c}from"./ProgramTemplate-BEh3YJj-.js";import{e as v,a as O}from"./ProgramTemplate-BEh3YJj-.js";import{gl as w}from"./index-BA7YOIPb.js";import{t as l}from"./NestedMap-GuqgquCN.js";class ${constructor(e){this._rctx=e,this._store=new l}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function p(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function d(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
