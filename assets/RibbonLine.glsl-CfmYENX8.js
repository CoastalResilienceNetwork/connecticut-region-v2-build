import{iQ as Bt,iP as Me,az as Re,iS as et,n8 as kt,kX as tt,tf as Ht,cI as k,av as x,dH as Ge,ax as We,kV as Jt,zj as Gt,dF as H,cH as xe,dM as Zt,aZ as q,d6 as Yt,db as it,kn as qt,gf as Xt,aF as S,yH as Qt,q9 as Kt,lo as ei,a0 as ti,fl as rt,sU as Te,bO as Ie,aQ as Et,t9 as ii,zI as se,n3 as _e,ds as De,zJ as W,cG as ue,du as at,dz as st,dB as Pe,dv as ri,sh as ai,kQ as si,n1 as ni,cJ as Ve,zK as oi,dj as li,am as ci,mY as di,zL as pi}from"./index-BA7YOIPb.js";import{t as ui}from"./orientedBoundingBox-Dpo4U1NY.js";import{aK as At,e as Ze,aL as hi,aM as fi,aj as Rt,ak as xt,al as Ct,$ as T,h as Y,H as be,aN as nt,a4 as mi,g as vi,i as Ye,w as qe,G as gi,a9 as Be,aO as Si,a5 as Ti,a8 as _i,c as bi,E as yi,aP as Oi,o as Ei,a6 as Ai,a7 as Ri,aa as xi,an as he,P as Ci,Q as Di,V as ot,aQ as Li,ac as lt,ad as Ii,ae as ct,af as Pi,ag as $i,ah as wi,ai as Ni,aR as Ui,aS as dt,aT as zi,aU as Fi,aV as ji,A as B,v as Mi,W as ae,y as ke,ap as Wi,aq as Vi,f as Bi}from"./VerticalOffset.glsl-dipaaKug.js";import{t as ki}from"./basicInterfaces-CZwQPxTp.js";import{s as Hi,m as Ji,H as Gi}from"./InterleavedLayout-xy_WcJlk.js";import{E as Zi,e as u}from"./VertexAttribute-Cq4MnHjR.js";import{t as Dt,f as Yi,r as qi,d as Xi}from"./HUDVisibility.glsl-dSjGJ6zp.js";import{b as Qi,j as ye}from"./Octree-DbJg3_2L.js";import{M as Ki,b as $e,v as Lt,B as er}from"./lineSegment-CUZeskHN.js";import{n as ne,u as pe,i as tr,S as ir,C as pt,e as rr}from"./ShaderOutput-DnYY5J1_.js";import{B as Oe,g as we,c as ut}from"./renderState-BKihUNRn.js";import{m as ar}from"./computeTranslationToOriginAndRotation-DvKq6bQ8.js";import{n as p,t as sr}from"./glsl-BH37Aalp.js";import"./BindType-BBwFZqyN.js";import"./floatRGBA-C7-r5xfe.js";import{i as nr}from"./ShaderBuilder-CqPV6FXe.js";class ma{constructor(e,i=null,r=0){this.array=e,this.spatialReference=i,this.offset=r}}function It(t){return"array"in t}function Ee(t,e,i="ground"){if(Dt(e))return t.getElevation(e.x,e.y,e.z||0,e.spatialReference,i);if(It(e)){let r=e.offset;return t.getElevation(e.array[r++],e.array[r++],e.array[r]||0,e.spatialReference??t.spatialReference,i)}return t.getElevation(e[0],e[1],e[2]||0,t.spatialReference,i)}let or=class extends At{get geometries(){return this._geometries}get transformation(){return this._transformation??Bt}set transformation(e){this._transformation=Me(this._transformation??Re(),e),this._invalidateBoundingVolume(),this._emit("transformationChanged",this)}get shaderTransformation(){return this._shaderTransformation}set shaderTransformation(e){this._shaderTransformation=e?Me(this._shaderTransformation??Re(),e):null,this._invalidateBoundingVolume(),this._emit("shaderTransformationChanged",this)}get effectiveTransformation(){return this.shaderTransformation??this.transformation}constructor(e={}){super(),this.type=Ze.Object,this._shaderTransformation=null,this._parentLayer=null,this._visible=!0,this.castShadow=e.castShadow??!0,this.usesVerticalDistanceToGround=e.usesVerticalDistanceToGround??!1,this.graphicUid=e.graphicUid,this.layerUid=e.layerUid,e.isElevationSource&&(this.lastValidElevationBB=new Pt),this._geometries=e.geometries?Array.from(e.geometries):new Array}dispose(){this._geometries.length=0}get parentLayer(){return this._parentLayer}set parentLayer(e){Hi(this._parentLayer==null||e==null,"Object3D can only be added to a single Layer"),this._parentLayer=e}addGeometry(e){e.visible=this._visible,this._geometries.push(e),this._emit("geometryAdded",{object:this,geometry:e}),this._invalidateBoundingVolume()}removeGeometry(e){const i=this._geometries.splice(e,1)[0];i&&(this._emit("geometryRemoved",{object:this,geometry:i}),this._invalidateBoundingVolume())}removeAllGeometries(){for(;this._geometries.length>0;)this.removeGeometry(0)}geometryVertexAttributeUpdated(e,i,r=!1){this._emit("attributesChanged",{object:this,geometry:e,attribute:i,sync:r}),Zi(i)&&this._invalidateBoundingVolume()}get visible(){return this._visible}set visible(e){if(this._visible!==e){this._visible=e;for(const i of this._geometries)i.visible=this._visible;this._emit("visibilityChanged",this)}}maskOccludee(){const e=new hi;for(const i of this._geometries)i.occludees=Yi(i.occludees,e);return this._emit("occlusionChanged",this),e}removeOcclude(e){for(const i of this._geometries)i.occludees=qi(i.occludees,e);this._emit("occlusionChanged",this)}highlight(e){const i=new fi(e);for(const r of this._geometries)r.addHighlight(i);return this._emit("highlightChanged",this),i}removeHighlight(e){for(const i of this._geometries)i.removeHighlight(e);this._emit("highlightChanged",this)}removeStateID(e){e.channel===ki.Highlight?this.removeHighlight(e):this.removeOcclude(e)}getCombinedStaticTransformation(e,i){return et(i,this.transformation,e.transformation)}getCombinedShaderTransformation(e,i=Re()){return et(i,this.effectiveTransformation,e.transformation)}get boundingVolumeWorldSpace(){return this._bvWorldSpace||(this._bvWorldSpace=this._bvWorldSpace||new ht,this._validateBoundingVolume(this._bvWorldSpace,fe.WorldSpace)),this._bvWorldSpace}get boundingVolumeObjectSpace(){return this._bvObjectSpace||(this._bvObjectSpace=this._bvObjectSpace||new ht,this._validateBoundingVolume(this._bvObjectSpace,fe.ObjectSpace)),this._bvObjectSpace}_validateBoundingVolume(e,i){const r=i===fe.ObjectSpace;for(const a of this._geometries){const s=a.boundingInfo;s&&lr(s,e,r?a.transformation:this.getCombinedShaderTransformation(a))}kt(tt(e.bounds),e.min,e.max,.5);for(const a of this._geometries){const s=a.boundingInfo;if(s==null)continue;const l=r?a.transformation:this.getCombinedShaderTransformation(a),o=Ht(l);k(ft,s.center,l);const n=Ge(ft,tt(e.bounds)),c=s.radius*o;e.bounds[3]=Math.max(e.bounds[3],n+c)}}_invalidateBoundingVolume(){var i;const e=(i=this._bvWorldSpace)==null?void 0:i.bounds;this._bvObjectSpace=this._bvWorldSpace=void 0,this._parentLayer&&e&&this._parentLayer.notifyObjectBBChanged(this,e)}_emit(e,i){this._parentLayer&&this._parentLayer.events.emit(e,i)}get test(){}};class Pt{constructor(){this.min=We(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),this.max=We(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE)}isEmpty(){return this.max[0]<this.min[0]&&this.max[1]<this.min[1]&&this.max[2]<this.min[2]}}class ht extends Pt{constructor(){super(...arguments),this.bounds=Jt()}}function lr(t,e,i){const r=t.bbMin,a=t.bbMax;if(Gt(i)){const s=H(cr,i[12],i[13],i[14]);xe(z,r,s),xe(j,a,s);for(let l=0;l<3;++l)e.min[l]=Math.min(e.min[l],z[l]),e.max[l]=Math.max(e.max[l],j[l])}else if(k(z,r,i),Zt(r,a))for(let s=0;s<3;++s)e.min[s]=Math.min(e.min[s],z[s]),e.max[s]=Math.max(e.max[s],z[s]);else{k(j,a,i);for(let s=0;s<3;++s)e.min[s]=Math.min(e.min[s],z[s],j[s]),e.max[s]=Math.max(e.max[s],z[s],j[s]);for(let s=0;s<3;++s){q(z,r),q(j,a),z[s]=a[s],j[s]=r[s],k(z,z,i),k(j,j,i);for(let l=0;l<3;++l)e.min[l]=Math.min(e.min[l],z[l],j[l]),e.max[l]=Math.max(e.max[l],z[l],j[l])}}}const cr=x(),z=x(),j=x(),ft=x();var fe;(function(t){t[t.WorldSpace=0]="WorldSpace",t[t.ObjectSpace=1]="ObjectSpace"})(fe||(fe={}));var Ce;(function(t){t[t.ASYNC=0]="ASYNC",t[t.SYNC=1]="SYNC"})(Ce||(Ce={}));const dr=["layerObjectAdded","layerObjectRemoved","layerObjectsAdded","layerObjectsRemoved","transformationChanged","shaderTransformationChanged","visibilityChanged","occlusionChanged","highlightChanged","geometryAdded","geometryRemoved","attributesChanged"];let pr=class extends At{constructor(e,i,r=""){super(),this.stage=e,this.apiLayerUid=r,this.type=Ze.Layer,this.events=new Yt,this.visible=!0,this.sliceable=!1,this._objectsAdded=new it,this._handles=new qt,this._objects=new it,this._pickable=!0,this.visible=(i==null?void 0:i.visible)??!0,this._pickable=(i==null?void 0:i.pickable)??!0,this.updatePolicy=(i==null?void 0:i.updatePolicy)??Ce.ASYNC,this._disableOctree=(i==null?void 0:i.disableOctree)??!1,e.add(this);for(const a of dr)this._handles.add(this.events.on(a,s=>e.handleEvent(a,s)))}destroy(){this._handles.size&&(this._handles.destroy(),this.stage.remove(this),this.invalidateSpatialQueryAccelerator())}get objects(){return this._objects}set pickable(e){this._pickable=e}get pickable(){return this._pickable&&this.visible}add(e){this._objects.push(e),e.parentLayer=this,this.events.emit("layerObjectAdded",{layer:this,object:e}),this._octree!=null&&this._objectsAdded.push(e)}remove(e){this._objects.removeUnordered(e)&&(e.parentLayer=null,this.events.emit("layerObjectRemoved",{layer:this,object:e}),this._octree!=null&&(this._objectsAdded.removeUnordered(e)||this._octree.remove([e])))}addMany(e){this._objects.pushArray(e);for(const i of e)i.parentLayer=this;this.events.emit("layerObjectsAdded",{layer:this,objects:e}),this._octree!=null&&this._objectsAdded.pushArray(e)}removeMany(e){const i=new Array;if(this._objects.removeUnorderedMany(e,e.length,i),i.length!==0){for(const r of i)r.parentLayer=null;if(this.events.emit("layerObjectsRemoved",{layer:this,objects:i}),this._octree!=null){for(let r=0;r<i.length;)this._objectsAdded.removeUnordered(i[r])?(i[r]=i[i.length-1],i.length-=1):++r;this._octree.remove(i)}}}sync(){this.updatePolicy!==Ce.SYNC&&this.stage.syncLayer(this.id)}notifyObjectBBChanged(e,i){this._octree==null||this._objectsAdded.includes(e)||this._octree.update(e,i)}getSpatialQueryAccelerator(){return this._octree==null&&this._objects.length>50&&!this._disableOctree?(this._octree=new Qi(e=>e.boundingVolumeWorldSpace.bounds),this._octree.add(this._objects.data,this._objects.length)):this._octree!=null&&this._objectsAdded.length>0&&(this._octree.add(this._objectsAdded.data,this._objectsAdded.length),this._objectsAdded.clear()),this._octree}invalidateSpatialQueryAccelerator(){this._octree=Xt(this._octree),this._objectsAdded.clear()}};var te,me;(function(t){t[t.Draped=0]="Draped",t[t.Screen=1]="Screen",t[t.World=2]="World",t[t.COUNT=3]="COUNT"})(te||(te={})),function(t){t[t.Center=0]="Center",t[t.Tip=1]="Tip",t[t.COUNT=2]="COUNT"}(me||(me={}));let F=class extends Rt{constructor(){super(...arguments),this.space=te.Screen,this.anchor=me.Center,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.vvSize=!1,this.vvColor=!1,this.vvOpacity=!1,this.hasOccludees=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.textureCoordinateType=xt.None,this.emissionSource=Ct.None,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVvInstancing=!0,this.hasSliceTranslatedView=!0,this.objectAndLayerIdColorInstanced=!1}get draped(){return this.space===te.Draped}};S([T({count:te.COUNT})],F.prototype,"space",void 0),S([T({count:me.COUNT})],F.prototype,"anchor",void 0),S([T()],F.prototype,"occluder",void 0),S([T()],F.prototype,"writeDepth",void 0),S([T()],F.prototype,"hideOnShortSegments",void 0),S([T()],F.prototype,"hasCap",void 0),S([T()],F.prototype,"hasTip",void 0),S([T()],F.prototype,"vvSize",void 0),S([T()],F.prototype,"vvColor",void 0),S([T()],F.prototype,"vvOpacity",void 0),S([T()],F.prototype,"hasOccludees",void 0),S([T()],F.prototype,"terrainDepthTest",void 0),S([T()],F.prototype,"cullAboveTerrain",void 0);const mt=8;function ur(t,e){const i=t.vertex;i.uniforms.add(new Y("intrinsicWidth",r=>r.width)),e.vvSize?(t.attributes.add(u.SIZEFEATUREATTRIBUTE,"float"),i.uniforms.add(new be("vvSizeMinSize",r=>r.vvSize.minSize),new be("vvSizeMaxSize",r=>r.vvSize.maxSize),new be("vvSizeOffset",r=>r.vvSize.offset),new be("vvSizeFactor",r=>r.vvSize.factor)),i.code.add(p`float getSize() {
return intrinsicWidth * clamp(vvSizeOffset + sizeFeatureAttribute * vvSizeFactor, vvSizeMinSize, vvSizeMaxSize).x;
}`)):(t.attributes.add(u.SIZE,"float"),i.code.add(p`float getSize(){
return intrinsicWidth * size;
}`)),e.vvOpacity?(t.attributes.add(u.OPACITYFEATUREATTRIBUTE,"float"),i.constants.add("vvOpacityNumber","int",8),i.uniforms.add(new nt("vvOpacityValues",r=>r.vvOpacity.values,mt),new nt("vvOpacityOpacities",r=>r.vvOpacity.opacityValues,mt)),i.code.add(p`float interpolateOpacity( float value ){
...
}`),a.uniforms.add(new gi("stipplePatternTexture",s=>s.stippleTexture),new Y("stipplePatternSDFNormalizer",s=>Sr(s.stipplePattern)),new Y("stipplePatternPixelSizeInv",s=>1/wt(s))),e.stippleOffColorEnabled&&a.uniforms.add(new Be("stippleOffColor",s=>mr(s.stippleOffColor))),a.code.add(p`float getStippleSDF(out bool isClamped) {
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Sr(t){return t?(Math.floor(.5*(fr(t)-1))+.5)/t.pixelRatio:1}function wt(t){const e=t.stipplePattern;return e?hr(t.stipplePattern)/e.pixelRatio:1}const Tr=.4,Nt=64,_r=Nt/2,br=_r/5,yr=Nt/br,Ta=.25;function Or(t,e){const i=t.vertex;qe(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",yr).code.add(p`float getLineWidth() {
